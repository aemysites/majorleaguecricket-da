...
## Environments
- Preview: https://main--majorleaguecricket-da--aemysites.aem.page/
- Live: https://main--majorleaguecricket-da--aemysites.aem.live/
- Block Library: https://main--majorleaguecricket-da--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `majorleaguecricket-da` directory in your favorite IDE and start coding :)
